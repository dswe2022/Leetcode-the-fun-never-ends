...
# Time Complexity O(a+ b + max(a,b)) where a and b are legnths of input strings.
# Space Complexity O(a+b) to store arrays nums1 and nums2.
...
# T: O(max(a,b)), a and b are lengths of the input strings respectively.
# S: O(max(a,b))